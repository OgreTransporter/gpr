...
namespace AdobeXMPCore {
	...
	public:
		...
		//!
		virtual pIArrayNode_base APICALL CreateArrayNode(AdobeXMPCommon::uint32 arrayForm, const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) __NOTHROW__ = 0;
