...
namespace AdobeXMPCore {
	...
	public:
		...
		//!
		XMP_PRIVATE static AdobeXMPCommon::uint32 GetInterfaceVersion() { return 1; }
		//! \endcond
	...
	protected:
		...
		//! \cond XMP_INTERNAL_DOCUMENTATION
		virtual AdobeXMPCommon::uint32 APICALL getParentNodeType( pcIError_base & error ) const __NOTHROW__ = 0;
		...
		virtual AdobeXMPCommon::uint32 APICALL getQualifierNodeType( const char * nameSpace, sizet nameSpaceLength, const char * name, sizet nameLength, pcIError_base & error ) const __NOTHROW__ = 0;
		...
		virtual AdobeXMPCommon::uint32 APICALL getNodeType( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual AdobeXMPCommon::uint32 APICALL isArrayItem( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual AdobeXMPCommon::uint32 APICALL isQualifierNode( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual sizet APICALL getIndex( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual AdobeXMPCommon::uint32 APICALL hasQualifiers( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual AdobeXMPCommon::uint32 APICALL hasContent( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual AdobeXMPCommon::uint32 APICALL isEmpty( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual AdobeXMPCommon::uint32 APICALL hasChanged( pcIError_base & error ) const __NOTHROW__ = 0;
		virtual void APICALL clear(AdobeXMPCommon::uint32 contents, AdobeXMPCommon::uint32 qualifiers, pcIError_base & error ) __NOTHROW__ = 0;
		virtual pINode_base APICALL clone(AdobeXMPCommon::uint32 igoreEmptyNodes, AdobeXMPCommon::uint32 ignoreNodesWithOnlyQualifiers, pcIError_base & error ) const __NOTHROW__ = 0;
